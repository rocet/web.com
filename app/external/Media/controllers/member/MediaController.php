...
class MediaController extends \BaseController {
    ...
    {
        //
        return \View::make('Media::member.index')->with(array('item' => $this->dataApi()->indexWithRelate( array('user', 'component') ) ));
    }
    ...
    {
        //
        return \View::make('Media::member.create');
    }
    ...
    public function edit($id)
    {
        ...
        return \View::make('Media::member.edit')->with(array('item' => $this->dataApi()->edit( $id ) ))->with( 'id', $id );
    }
